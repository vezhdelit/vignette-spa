...
export const en = {
  ...
  "wallet.topUp.continue": "Continue",
  ...
  "account.referrals.haveCode": "Got an invite code?",
  "account.referrals.codePlaceholder": "Invite code",
  "account.referrals.apply": "Apply",
  "account.referrals.claimed": "You were invited by {name}",
  "account.referrals.alreadyInvited": "This account already has an inviter.",
